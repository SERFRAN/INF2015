...
public class Regles {    
    ...
    private static boolean aTravailleMinHeuresBureauJOuvrables( FeuilleTemps feuilleTemps ) {
        ...
        Employe employe = feuilleTemps.obtenirEmploye();
        if ( employe.estUnEmployeAdministration() ) {
            regle = feuilleTemps.ValiderTempsBureauJOuvrables(MIN_HEURES_BUREAU_ADM_JO * 60);
        } else {
            regle = feuilleTemps.ValiderTempsBureauJOuvrables(MIN_HEURES_BUREAU_NOR_JO * 60);
        }
        return regle;
    }
